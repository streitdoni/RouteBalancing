...
double AODVQoSRouting::determineQoSRREQTreatment(double requiredBandwidth, double requiredSlotTime)
{
     ...
     *****************************/
    double maxTreatedDelay = (0.000386 * 30 * 2);
